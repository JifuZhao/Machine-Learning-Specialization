...
plt.imshow(img)
plt.axis('tight')
plt.savefig('./result/feature_result/raw_data.eps', dpi=100)
plt.savefig('./result/feature_result/raw_data.png', dpi=500)
...
f = open('./result/feature_result/static_random_classify.txt', 'w')
