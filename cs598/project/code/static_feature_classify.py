...
true = np.concatenate((true_1, true_2, sheng_true), axis=1)
false = np.concatenate((false_1, false_2, sheng_false), axis=1)
...
delta = 0.80
filename = './result/static_feature_result/' + str(round(delta*100)) + '_static_random_classify.txt'
f = open(filename, 'w')
