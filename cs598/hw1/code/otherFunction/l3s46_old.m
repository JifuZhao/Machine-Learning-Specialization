...
% Out1 = convolutionMatrix(img1, C1, y, x, N1, M1);
...
% Out2 = convolutionMatrix(img2, C2, y, x, N2, M2);
...
% end
% 
% Out3 = convolutionMatrix(img3, C3, y, x, N3, M3);
...
% Out4 = convolutionMatrix(img4, C4, y, x, N4, M4);
