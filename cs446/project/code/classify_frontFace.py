...
f = open('./figures/front_classify/front_original_space.txt', 'w')
...
for i in range(5):
    ...
    train_name = './cross_data/front_train_' + str(i+1) + '.npz'
    test_name = './cross_data/front_test_' + str(i+1) + '.npz'
...
#%% PCA Space
print('*********** PCA Space ***********\n')
f = open('./figures/front_classify/front_pca_space.txt', 'w')
...
#sio.savemat('./figures/front_classify/train_accuracy.mat', {'DT_train': DT_train, 'LDA_train': LDA_train, 
#                                                            'QDA_train': QDA_train, 'KNN_train': KNN_train, 
#                                                            'SVM_train_rbf': SVM_train_rbf, 
#                                                            'SVM_train_linear': SVM_train_linear })
#                                                            
#sio.savemat('./figures/front_classify/test_accuracy.mat', {'DT_test': DT_test, 'LDA_test': LDA_test, 
...
plt.savefig('./figures/front_classify/DecisionTree.eps', dpi=100)
plt.savefig('./figures/front_classify/DecisionTree.png', dpi=400)
...
plt.xlim([0.1, 0.96]); plt.ylim([0, 1.05]); plt.grid('on')
plt.savefig('./figures/front_classify/LDA.eps', dpi=100)
plt.savefig('./figures/front_classify/LDA.png', dpi=400)
...
plt.xlim([0.1, 0.96]); plt.ylim([0, 1.05]); plt.grid('on')
plt.savefig('./figures/front_classify/QDA.eps', dpi=100)
plt.savefig('./figures/front_classify/QDA.png', dpi=400)
...
plt.xlim([0.1, 0.96]); plt.ylim([0, 1.05]); plt.grid('on')
plt.savefig('./figures/front_classify/KNN.eps', dpi=100)
plt.savefig('./figures/front_classify/KNN.png', dpi=400)
...
plt.xlim([0.1, 0.96]); plt.ylim([0, 1.05]); plt.grid('on')
plt.savefig('./figures/front_classify/SVM_train_rbf.eps', dpi=100)
plt.savefig('./figures/front_classify/SVM_train_rbf.png', dpi=400)
...
plt.xlim([0.1, 0.96]); plt.ylim([0, 1.05]); plt.grid('on')
plt.savefig('./figures/front_classify/SVM_train_linear.eps', dpi=100)
plt.savefig('./figures/front_classify/SVM_train_linear.png', dpi=400)
...
plt.ylabel('Accuracy')
plt.xlim([0.1, 0.96]); plt.ylim([0, 1.05]); plt.grid('on')
plt.savefig('./figures/front_classify/total_train.eps', dpi=100)
plt.savefig('./figures/front_classify/total_train.png', dpi=400)
...
plt.ylabel('Accuracy')
plt.xlim([0.1, 0.96]); plt.ylim([0, 1.05]); plt.grid('on')
plt.savefig('./figures/front_classify/total_test.eps', dpi=100)
plt.savefig('./figures/front_classify/total_test.png', dpi=400)
