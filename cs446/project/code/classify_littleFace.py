...
f = open('./figures/little_classify/little_original_space.txt', 'w')
...
for i in range(5):
    ...
    train_name = './cross_data/little_train_' + str(i+1) + '.npz'
    test_name = './cross_data/little_test_' + str(i+1) + '.npz'
...
#%% PCA Space
print('*********** PCA Space ***********\n')
f = open('./figures/little_classify/little_pca_space.txt', 'w')
...
#        train_accuracy = face_accuracy(train_label, prediction_train)
#        test_accuracy = face_accuracy(test_label, prediction_test)
#        SVM_train_poly[i, j] = train_accuracy
#        SVM_test_poly[i, j] = test_accuracy
#        f.write('SVM with polynomial kernel, the training accuracy is: ' + str(train_accuracy) + '\n')
#        f.write('SVM with polynomial kernel, the training accuracy is: ' + str(test_accuracy) + '\n' + '\n')
#        #    print('SVM with polynomial kernel, the training accuracy is:', train_accuracy)
#        #    print('SVM with polynomial kernel, the test accuracy is:', test_accuracy)
...
#        train_accuracy = face_accuracy(train_label, prediction_train)
#        test_accuracy = face_accuracy(test_label, prediction_test)
#        SVM_train_sig[i, j] = train_accuracy
#        SVM_test_sig[i, j] = test_accuracy
#        f.write('SVM with sigmoid kernel, the training accuracy is: ' + str(train_accuracy) + '\n')
#        f.write('SVM with sigmoid kernel, the test accuracy is: ' + str(test_accuracy) + '\n' + '\n')
#        #    print('SVM with sigmoid kernel, the training accuracy is:', train_accuracy)
#        #    print('SVM with sigmoid kernel, the test accuracy is:', test_accuracy)
...
#sio.savemat('./figures/little_classify/train_accuracy.mat', {'DT_train': DT_train, 'LDA_train': LDA_train, 
#                                                            'QDA_train': QDA_train, 'KNN_train': KNN_train, 
#                                                            'SVM_train_rbf': SVM_train_rbf, 
#                                                            'SVM_train_linear': SVM_train_linear })
#                                                            
#sio.savemat('./figures/little_classify/test_accuracy.mat', {'DT_test': DT_test, 'LDA_test': LDA_test, 
...
plt.savefig('./figures/little_classify/DecisionTree.eps', dpi=100)
plt.savefig('./figures/little_classify/DecisionTree.png', dpi=400)
...
plt.xlim([0.1, 0.96]); plt.ylim([0, 1.05]); plt.grid('on')
plt.savefig('./figures/little_classify/LDA.eps', dpi=100)
plt.savefig('./figures/little_classify/LDA.png', dpi=400)
...
plt.xlim([0.1, 0.96]); plt.ylim([0, 1.05]); plt.grid('on')
plt.savefig('./figures/little_classify/QDA.eps', dpi=100)
plt.savefig('./figures/little_classify/QDA.png', dpi=400)
...
plt.xlim([0.1, 0.96]); plt.ylim([0, 1.05]); plt.grid('on')
plt.savefig('./figures/little_classify/KNN.eps', dpi=100)
plt.savefig('./figures/little_classify/KNN.png', dpi=400)
...
plt.xlim([0.1, 0.96]); plt.ylim([0, 1.05]); plt.grid('on')
plt.savefig('./figures/little_classify/SVM_train_rbf.eps', dpi=100)
plt.savefig('./figures/little_classify/SVM_train_rbf.png', dpi=400)
...
plt.xlim([0.1, 0.96]); plt.ylim([0, 1.05]); plt.grid('on')
plt.savefig('./figures/little_classify/SVM_train_linear.eps', dpi=100)
plt.savefig('./figures/little_classify/SVM_train_linear.png', dpi=400)
...
plt.ylabel('Accuracy')
plt.xlim([0.1, 0.96]); plt.ylim([0, 1.05]); plt.grid('on')
plt.savefig('./figures/little_classify/total_train.eps', dpi=100)
plt.savefig('./figures/little_classify/total_train.png', dpi=400)
...
plt.xlabel('PCA component ratio')
plt.ylabel('Accuracy')
plt.savefig('./figures/little_classify/total_test.eps', dpi=100)
plt.savefig('./figures/little_classify/total_test.png', dpi=400)